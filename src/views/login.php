<section class="container auth">
  <div class="auth__grid">
    <div class="auth__left">
      ...
      <form class="auth-form" method="post" action="/?page=login_post">
        ...
        <button class="btn btn--primary auth-form__btn" type="submit">Se connecter</button>

        <div class="auth__links">
          <a class="link" href="/?page=register">Créer un compte</a>
        </div>
      </form>
    </div>
